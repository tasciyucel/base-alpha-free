...
# Daha önce analiz edilmeden geçilmiş aralık
...
def main():
    ...
    # Önce kaçırılmış eski aralık
    if last_scanned is not None and last_scanned >= BACKFILL_START:

        if last_scanned <= BACKFILL_END:
